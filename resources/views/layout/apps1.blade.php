        ...
        <div class="nk-sidebar">
            <div class="nk-nav-scroll">
                <ul class="metismenu" id="menu">
                    ...
                    <li><a href="{{ url('/admin/support') }}"><i class="mdi mdi-alert-decagram"></i> <span class="nav-text">Supports</span></a></li>
                    ...
                    <li><a href="{{ url('/admin/withdraw-info') }}"><i class="mdi mdi-chart-bar"></i> <span class="nav-text">Withdrawal Info</span></a></li>

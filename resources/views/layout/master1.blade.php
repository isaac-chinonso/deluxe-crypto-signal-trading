                        ...
                        <div class="clearfix">
                            <div class="wt-topbar-left">
                                <ul class="list-unstyled e-p-bx pull-left">
                                    <li><i class="fa fa-envelope"></i>info@deluxecryptosignaltrading.com</li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            ...
                            <div class="wt-topbar-right">
                                ...
                                <ul class="list-unstyled e-p-bx pull-right">
                                    <li><a href="{{ url('/register') }}"><i class="fa fa-sign-in"></i>Join Deluxe Crypto Signal Trading</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
            ...
            <div class="main-bar header-middle bg-white">
                <div class="container">
                    <div class="logo-header">
                        <a href="{{ url('/') }}">
                            <img src="asset/images/logo1.png" width="216" height="37" alt="" />
                        </a>
                    </div>
                    <div class="header-info">
                        <ul>
                            <li class="btn-col-last">
                                <a href="{{ url('/register') }}" class="site-button text-uppercase radius-sm font-weight-700">Get Started</a>
                            </li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="container p-t30">
                    <div class="row">
                        <div class="wt-footer-bot-left">
                            <span class="copyrights-text">© 2021 Deluxe Crpto Trading Signal. All Rights Reserved. Powered By <a href="#">Dcode Arena</a></span>
                        </div>
